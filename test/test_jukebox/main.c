// usage: ~/.platformio/penv/bin/platformio test --environment bluepill_f103c8 -f test_jukebox
...
#define INTERNAL_LED_PORT GPIOB
#define INTERNAL_LED GPIO12
#define RCC_INTERNAL_LED RCC_GPIOB
